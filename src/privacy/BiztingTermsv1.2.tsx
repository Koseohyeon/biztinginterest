    ...
    <ClauseStaticDocument styles={styles}>
      <div className="page-wrap">
        ...
        <Article id="a2" num="2" title="용어의 정의">
          ...
          <ParenList
            items={[
              ...
              "N-Pass: 비즈팅이 네이버 로그인 플러스의 외부 인증 수단을 통해 수집한 메시지 수신자의 개인정보를 회원(고객사)에게 제 3자 제공하고, 이를 활용하여 마케팅·회원 유치 및 관리 목적으로 활용할 수 있도록 지원하는 부가 서비스를 말합니다.",
          ...
          <ParenList
            items={[
              ...
              <>
                ...
                <DotNumList
                  items={[
                    "회원은 N-Pass 서비스를 통해 제 3자 제공받은 개인정보 일체를 고지된 목적(마케팅·회원 유치 및 관리) 외의 용도로 이용하거나, 제3자에게 재제공하거나, 유상으로 판매하여서는 아니 됩니다.",
        ...
        <Article id="a22-2" num="22의2" title="N-Pass의 제공">
          <ParenList
            items={[
              "회사는 메시지 수신자가 비즈팅 N-Pass기능 페이지에서 개인정보 수집·제공에 동의한 경우, 해당 정보를 수집하여 회원(고객사)에게 제 3자 제공하여 지원하는 N-Pass 서비스를 제공합니다.",
              "N-Pass 서비스는 회원이 별도의 'N-Pass 서비스 이용 및 보안 서약'(이하 '보안 서약')에 동의하고 서비스를 활성화한 경우에만 이용할 수 있습니다.",
              "회사는 N-Pass 서비스를 통해 제 3자 제공을 위해 수집·활용하는 개인정보의 항목, 목적, 보유 기간 등을 '개인정보처리방침' 및 정보주체의 동의 화면에 명시합니다.",
              ...
              <>
                ...
                <DotNumList
                  items={[
                    ...
                    "제 3자 제공받은 정보를 명시된 목적(마케팅·회원 유치) 외 사용 및 외부 유출 금지",
        ...
        <Article id="a33" num="33" title="면책조항">
          <ParenList
            items={[
              ...
              "회사는 N-Pass 서비스를 통해 회원에게 제 3자 제공한 개인정보의 활용 과정에서 발생하는 손해에 대하여 책임을 지지 않습니다. 본 서비스에서 회사의 책임은 적법한 동의 기반의 수집 및 안전한 정보 제공 시스템 운영에 한정되며, 회원이 해당 정보를 제공받아(또는 다운로드하여) 마케팅 등에 직접 활용하는 과정에서 발생하는 제반 민·형사상 책임은 전적으로 회원에게 있습니다",
            ]}
          />
        </Article>
