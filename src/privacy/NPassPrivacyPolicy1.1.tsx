...
// ── Sub Components ──────────────────────────────────────
const Section = ({ num, title, badge, children }: SectionProps) => (
  <div className="tw-bg-white tw-border tw-border-slate-200 tw-rounded-2xl tw-mb-5 tw-overflow-hidden">
    <div className="tw-flex tw-items-center tw-gap-3 tw-px-7 tw-py-5 tw-border-b tw-border-slate-100 tw-bg-slate-50">
      ...
      {badge && (
        <span className="tw-inline-flex tw-items-center tw-bg-blue-50 tw-text-[#1a6ef5] tw-text-[10.5px] tw-font-bold tw-px-2.5 tw-py-0.5 tw-rounded-full tw-tracking-wide">
          신규
        </span>
      )}
    </div>
  ...
  <div className="tw-grid tw-grid-cols-2 tw-gap-x-6 tw-gap-y-1">
    {tocItems.map((item) => (
      ...
      >
        ...
        {/* ════════════════════════════════════════════
            섹션 1. 개인정보의 처리 목적, 수집 항목, 보유 및 이용기간
        ════════════════════════════════════════════ */}
        <div id="s1">
          <Section num={1} title="개인정보의 처리 목적, 수집 항목, 보유 및 이용기간">
            ...
            {/* 보유기간 표 */}
            <p className="tw-text-[14px] tw-text-slate-600 tw-leading-relaxed tw-mb-2">
              단, 아래 사유에 따라 일정 기간 보관합니다.
            </p>
            <DataTable
              headers={["구분", "보유 기간"]}
              rows={[
              ...
              <span>
                ...
                <NoteBox>
                  ...
                  <div className="tw-mt-2 tw-space-y-1">
                    <div className="tw-flex tw-gap-2 tw-text-[13px]">
          ...
          <Section num={4} title="개인정보 처리업무의 위탁">
            <DataTable
              ...
              rows={[
                ...
                ["카카오", "알림톡 및 친구톡 메시지 발송", "위탁 계약 종료 시"],
        ...
        <div id="s12">
          <Section num={12} title="개인정보 처리방침의 변경">
            <div className="tw-flex tw-gap-6 tw-flex-wrap tw-bg-blue-50 tw-border tw-border-blue-200 tw-rounded-xl tw-px-5 tw-py-4 tw-text-[14px] tw-font-medium tw-text-[#081f4a] tw-mb-4">
              <span><span className="tw-font-normal tw-text-slate-400 tw-mr-1">공고일자</span>2026.4.21</span>
              <span><span className="tw-font-normal tw-text-slate-400 tw-mr-1">시행일자</span>2026.5.22</span>
            </div>
            <ItemRow circle="①">
              <span>
                이전의 개인정보 처리방침이 있을 경우, 상단의 '이전 버전'에서 확인하실 수 있습니다.
              </span>
            </ItemRow>
            <ItemRow circle="②">
              <span>
