                ...
                <div className="sub-list">
                  <div className="sub-row">
                    ...
                    <span>
                      ...
                      <a href="http://www.kopico.go.kr" target="_blank" rel="noreferrer" style={{ color: "var(--accent)" }}>{"www.kopico.go.kr"}</a>
                      {")"}
                    </span>
                  </div>
                  <div className="sub-row">
                    ...
                    <span>
                      {"개인정보침해신고센터: (국번없이) 118 ("}
                      <a href="http://privacy.kisa.or.kr" target="_blank" rel="noreferrer" style={{ color: "var(--accent)" }}>{"privacy.kisa.or.kr"}</a>
                      {")"}
                    </span>
                  </div>
                  <div className="sub-row">
                    ...
                    <span>
                      {"대검찰청: (국번없이) 1301 ("}
                      <a href="http://www.spo.go.kr" target="_blank" rel="noreferrer" style={{ color: "var(--accent)" }}>{"www.spo.go.kr"}</a>
                      {")"}
                    </span>
                  </div>
                  <div className="sub-row">
                    ...
                    <span>
                      {"경찰청: (국번없이) 182 ("}
                      <a href="http://ecrm.cyber.go.kr" target="_blank" rel="noreferrer" style={{ color: "var(--accent)" }}>{"ecrm.cyber.go.kr"}</a>
                      {")"}
                    </span>
                  </div>
                </div>
        ...
        <div className="modal" id="modal">
          ...
          <div className="modal-body">
            ...
            <div style={{ marginTop: "20px", textAlign: "center" }}>
              <button
                type="button"
                data-route="/clause/privacy/v1.1"
                style={{ display: "inline-block", padding: "12px 20px", background: "#1a6ef5", color: "#fff", borderRadius: "8px", textDecoration: "none", fontWeight: "600", fontSize: "13px", border: "none", cursor: "pointer", fontFamily: "inherit" }}
              >
                {"현재 버전 확인하기"}
              </button>
            </div>
