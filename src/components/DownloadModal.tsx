...
export default function DownloadModal({ onConfirm, onClose }: any) {
  ...
  return (
    <div className="tw-fixed tw-inset-0 tw-bg-black/40 tw-flex tw-items-center tw-justify-center tw-z-50">
      ...
      <div className="tw-bg-white tw-w-full tw-max-w-md tw-rounded-2xl tw-p-7 tw-shadow-xl">
        ...
        <div className="tw-bg-blue-50 tw-text-[#5D87FF] tw-text-sm tw-rounded-lg tw-p-3 tw-mb-6 tw-text-center">
