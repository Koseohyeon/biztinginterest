              ...
              <div className="tw-max-w-[1040px] tw-mx-auto">
                ...
                <div className={`${cardCls} tw-mt-8 tw-p-6 tw-bg-[#FFF9EC] tw-border-[#F5E4B8]`}>
                  ...
                  <ul className="tw-m-0 tw-pl-4.5 tw-text-[12.5px] tw-text-[#8A6100] tw-leading-loose tw-list-disc">
                    ...
                    <li>캐시 부족으로인한 자동발송이 2회 스킵되면 정기발송이 중지돼요.</li>
                    ...
                    <li> 최초 등록 캠페인 기준으로 영업일 기준 오후 3시 이전 등록 건은 당일 접수로 처리되어 2영업일 후 발송되고, 오후 3시 이후 등록 건은 다음 영업일부터 기산하여 2영업일 후 발송됩니다. (예: 8/18 오후 3시 이전 등록 → 8/20 발송, 오후 3시 이후 등록 → 8/21 발송) </li>
                  </ul>
                </div>
              </div>
            </>
