...
// ─── 3. General Coupon ───
const GeneralCoupon = ({ title, desc, code, icon: Icon, colorClass }: any) => {
  ...
  return (
    <div className="tw-bg-white tw-rounded-[1.5rem] tw-p-5 tw-mb-4 tw-shadow-sm tw-border tw-border-gray-100">
      ...
      <div className="tw-bg-[#F8FAF9] tw-rounded-xl tw-p-4 tw-text-center">
              ...
              <div className="tw-mb-8 tw-mt-2">
                ...
                {timeSaleProducts.map(item=>(
                  <div key={item.id} onClick={()=>openCoupon(item)}
                    ...
                    {/* 이미지 */}
                    <div className="tw-w-28 tw-h-28 tw-rounded-2xl tw-overflow-hidden tw-shrink-0 tw-relative">
